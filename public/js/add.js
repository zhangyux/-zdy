					...
					switch(querstionType) {
						...
						case "1": //多选	
							...
							jcxxxx.children(".title_itram").children(".kzjxx_iteam").each(function() {
								...
								//修改选项
								var questionname = jcxxxx.parent(".movie_box").children(".wjdc_list").children(".rad").val();
								// alert(questionname);


								var li = '<li><label><input class="'+questionname+'" name="a" id="'+bjjs_bj+questionname+'"  type="' + inputType + '" value=""><span>' + texte_val_bj + '</span></label></li>';
