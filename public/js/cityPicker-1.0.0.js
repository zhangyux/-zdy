        ...
        seTemplet: function () {
            ...
            for (var i = 0; i < config.level; i++) { //循环定义的级别
                ...
                if (config.renderMode) {
                    ...
                    //原生
                    if(field == 'userProvinceId')
                    {
                         selectemplet += '<select id = "province" name="' + field + '" data-index="' + i + '" class="' + citygrade + '">'
                        +'<option value="0">' + placeholder + '</option>'
                    +'</select>';
                    }
                     if(field == 'userCityId')
                    {
                         selectemplet += '<select id = "city" name="' + field + '" data-index="' + i + '" class="' + citygrade + '">'
                        +'<option value="0">' + placeholder + '</option>'
                    +'</select>';
                    }
                     if(field == 'userDistrictId')
                    {
                         selectemplet += '<select id = "district" name="' + field + '" data-index="' + i + '" class="' + citygrade + '">'
                        +'<option value="0">' + placeholder + '</option>'
                    +'</select>';
                    }
